        ...
        if round == 0:
            ...
            for ni in range(num_clients):
                if ni == 0 :
                    ...
                    marg_util_normalized = marg_util_normalized - val[V_set]
                    ...
                    print ("client we have selected has column sum", min(marg_util))
                    ...
                    marg_util = (marg_util_normalized-val[V_set])
                    ...
                    #print ("minimum column sum of the selected clients", ans_sum)
                    print ("client we have selected has column sum", min(marg_util))
            ...
            print("Clients and their marginal utilities:", marg_util_dict)
            print("Length of dictionary is:", len(marg_util_dict))
